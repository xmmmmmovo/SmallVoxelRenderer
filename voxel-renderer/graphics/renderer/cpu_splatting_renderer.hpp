...
private:
    ...
    std::unique_ptr<OGLPipeline>   _fb_pipeline{nullptr};
    std::unique_ptr<OGLRenderPass> _fb_render_pass{nullptr};
    ...
    OGLShader _quad_vert_shader{};
    OGLShader _quad_frag_shader{};
...
public:
    void init() noexcept override {
        ...
        _quad_vert_shader.initShaderFromSource(OGLShaderType::VERTEX,
                                               QUAD_VERT_GL);
        _quad_frag_shader.initShaderFromSource(OGLShaderType::FRAGMENT,
                                               QUAD_FRAG_GL);
        OGLShaderProgram quad_shader_program;
        quad_shader_program.attach(_quad_vert_shader);
        quad_shader_program.attach(_quad_frag_shader);
