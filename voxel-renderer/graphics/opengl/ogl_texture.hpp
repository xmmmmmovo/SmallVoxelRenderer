...
public:
    explicit OGLTexture(OGLTextureDescription description)
        ...
        create_texture();
        if (_description.empty) { emptyTexture(); }
    };
