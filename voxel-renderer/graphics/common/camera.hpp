//
// Created by xmmmmmovo on 31/07/2023.
//

#ifndef VOXEL_RENDERER_GRAPHICS_COMMON_CAMERA_HPP
#define VOXEL_RENDERER_GRAPHICS_COMMON_CAMERA_HPP
...
static constexpr float NORMAL_SPEED = 6.0f;
static constexpr float FASTS_PEED   = 12.0f;
static constexpr float SENSITIVITY  = 0.1f;
static constexpr float ZOOM         = 45.0f;

class EulerCamera final {
private:
...
#endif//VOXEL_RENDERER_GRAPHICS_COMMON_CAMERA_HPP
